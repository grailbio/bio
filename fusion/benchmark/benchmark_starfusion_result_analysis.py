...
def main() -> None:
  ...
  p.add_argument('--starfusion_dir', default="/scratch-nvme/xyang/result/",
                 help='Starfusion result dir, which then contains individual sample result')
  p.add_argument('--cache_dir', default="/scratch-nvme/xyang/cache/",
                 help='cache dir')
  ...
  filtered_results = [f for f in listOfFiles if f.find("star-fusion.fusion_predictions.abridged.tsv") != -1]
