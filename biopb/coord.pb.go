...
/*
	Package biopb is a generated protocol buffer package.

	It is generated from these files:
		proto/bio/coord.proto
		proto/bio/pam.proto
		proto/bio/sort.proto
...
func (*Coord) Descriptor() ([]byte, []int) { return fileDescriptorCoord, []int{0} }
...
type CoordRange struct {
	Start Coord `protobuf:"bytes,1,opt,name=start" json:"start"`
	Limit Coord `protobuf:"bytes,2,opt,name=limit" json:"limit"`
}
...
func (*CoordRange) Descriptor() ([]byte, []int) { return fileDescriptorCoord, []int{1} }
...
func encodeFixed64Coord(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32Coord(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
...
func init() { proto.RegisterFile("proto/bio/coord.proto", fileDescriptorCoord) }

var fileDescriptorCoord = []byte{
	...
	0xd8, 0x1e, 0x82, 0x7a, 0xc0, 0x4a, 0x9d, 0xf4, 0x4f, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e,
	0xf1, 0xc1, 0x23, 0x39, 0xc6, 0x09, 0x8f, 0xe5, 0x18, 0xa2, 0x64, 0x91, 0xbd, 0x0e, 0x32, 0x00,
	0x14, 0x58, 0x50, 0x5c, 0x90, 0x94, 0xc4, 0x06, 0x36, 0xce, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff,
	0xc0, 0xf8, 0x2c, 0x6d, 0x4a, 0x01, 0x00, 0x00,
}
